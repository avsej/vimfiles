  ...
  if (!exists("g:rails_syntax") || g:rails_syntax)
    ...
    if &syntax == 'ruby'
      ...
      elseif buffer.type_name('spec')
        syn keyword rubyRailsTestMethod describe context example it its specify it_should_behave_like before after subject fixtures controller_name helper_name
